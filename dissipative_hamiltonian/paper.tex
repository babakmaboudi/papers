...
\begin{abstract}
Reduced basis methods are popular for approximately solving large and complex systems of differential equations. However, conventional methods do not generally preserve conservation laws and symmetries of the full order model. Here, we present The Reduced Dissipative Hamiltonian Method, that preserves the symplectic symmetry of dissipative Hamiltonian systems over the course of model reduction. This method constructs a closed reduced Hamiltonian system by coupling the full model with a canonical heat bath. This results in a correct dissipation of energy, preservation of total energy and ultimately in the stability of the solution. Accuracy and stability of the method is illustrated through the numerical simulation of the dissipative wave equation and a port-Hamiltonian model of an electric circuit.
