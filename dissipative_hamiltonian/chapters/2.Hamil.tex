...
\end{equation}
\end{proof}
Then, we can recover (\ref{eq:2.4.1}) by substituting (\ref{eq:2.12}) into (\ref{eq:2.11}). The extended Hamiltonian $H_\text{ex}$ for the system (\ref{eq:2.10.a}-\ref{eq:2.10.c}) takes the quadratic from
