...
{\edit Numerical solution of (\ref{eq:MoOr:8}) sometimes involve computation of the Jacobian of the nonlinear function $\mathbf g(t,\mathbf x, \omega)$ with respect to the reduced state variable $\mathbf y$}
